...
const playlistSlice = createSlice({
  ...
  reducers: {
    ...
    setActiveFilter: (state, action: PayloadAction<PlaylistStateType>) => {
      state.activeFilters = {
        author:
          action.payload.activeFilters.author || state.activeFilters.author,
        release_date: action.payload.activeFilters.release_date || null,
        genre: action.payload.activeFilters.genre || state.activeFilters.genre,
        searchValue:
          action.payload.activeFilters.searchValue ||
          state.activeFilters.searchValue,
      };
